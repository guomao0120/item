...
@interface GossipInfoViewController ()
...
@implementation GossipInfoViewController
...
- (void)setUpData{
    ...
    NSString *string =[NSString stringWithFormat:@"http://api.iclient.ifeng.com/ipadtestdoc?aid=%@&cmpp_channelid=ent&gv=5.1.1&av=0&proid=ifengnews&os=ios_9.1&vt=5&screen=640x1136&publishid=4002&uid=454db92936f54288b38b5af04f18ee16",_model.documentId];
